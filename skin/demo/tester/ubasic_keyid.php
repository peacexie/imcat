...
echo '<br>'.basKeyid::kidRand('fs',32);
echo '<br>'.basKeyid::kidRand('fs',32);
echo '<br>'.basKeyid::kidTemp('max');
echo '<br>'.basKeyid::kidTemp('md2');

echo '<br>';
echo '<br>'.basKeyid::kidTemp('md3');
echo '<br>4:'.basKeyid::kidTemp('md2');
echo '<br>'.basKeyid::kidTemp('mdh');
...
echo '<br>'.basKeyid::kidTemp('mdh','2012-01-01 12:30');
echo '<br>'.basKeyid::kidTemp('mdh','2012-12-31 00:00');
echo '<br>'.basKeyid::kidTemp('mdh','2012-09-09 00:01');
echo '<br>'.basKeyid::kidTemp('mdh','2012-09-10 00:09');
echo '<br>'.basKeyid::kidTemp('mdh','2012-09-11 23:10');
echo '<br>'.basKeyid::kidTemp('mdh','2012-09-12 23:13');
echo '<br>'.basKeyid::kidTemp('mdh','2012-09-13 23:58:59');
echo '<br>'.basKeyid::kidTemp('mdh','2012-09-14 23:59:59');
echo '<br>';

echo '<br>'.microtime(1);
for($i=0;$i<5;$i++) echo "<br>--- run - basKeyid::kidTemp(md2): ".basKeyid::kidTemp('md2');    
echo '<br>'.microtime(1);

echo '<br>'.microtime(1);
for($i=0;$i<5;$i++) echo "<br>--- run - basKeyid::kidTemp(md2): ".basKeyid::kidTemp('md2');    
echo '<br>'.microtime(1);
for($i=0;$i<5;$i++) echo "<br>--- run - basKeyid::kidTemp(md3): ".basKeyid::kidTemp('md3');    
echo '<br>'.microtime(1);
for($i=0;$i<5;$i++) echo "<br>--- run - basKeyid::kidTemp(mdh): ".basKeyid::kidTemp('mdh');    
echo '<br>'.microtime(1);
for($i=0;$i<5;$i++) echo "<br>--- run - basKeyid::kidTemp(5.5): ".basKeyid::kidTemp('5.5');    
echo '<br>'.microtime(1);
echo '<br>'.microtime(1);
for($i=0;$i<5;$i++) echo "<br>--- run - basKeyid::kidTemp(5.5): ".basKeyid::kidTemp('5.5');    
echo '<br>'.microtime(1);
...
echo '<br>';
echo '<br>'.basKeyid::kidTemp('md2','2012-07-06 09:27:00');
echo '<br>'.basKeyid::kidTemp('md2','2012-07-06 09:29:00');
echo '<br>'.basKeyid::kidTemp('md2','2012-07-06 09:31:00');
echo '<br>'.basKeyid::kidTemp('md2','2012-07-06 09:33:00');
echo '<br>'.basKeyid::kidTemp('md2','2012-07-06 09:35:00');
echo '<br>'.basKeyid::kidTemp('md2','2012-07-06 09:37:00');
echo '<br>';
echo '<br>'.basKeyid::kidTemp('md2','2012-07-05 00:00:00');
echo '<br>'.basKeyid::kidTemp('md2','2012-07-05 00:00:01');
echo '<br>'.basKeyid::kidTemp('md2','2012-07-05 00:00:02');
echo '<br>'.basKeyid::kidTemp('md2','2012-07-05 00:00:03');
echo '<br>'.basKeyid::kidTemp('md2','2012-07-04 23:59:57');
echo '<br>'.basKeyid::kidTemp('md2','2012-07-04 23:59:58');
echo '<br>'.basKeyid::kidTemp('md2','2012-07-04 23:59:59');

dump(basKeyid::kidTemp(0));
