...
<link href="<?php echo PATH_VIEWS; ?>/base/assets/cssjs/cinfo.css?v1" type='text/css' rel='stylesheet'/>
<script src="<?php echo PATH_VIEWS; ?>/base/assets/jslib/jsbase.js?v1"></script>
