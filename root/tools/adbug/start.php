...
<meta charset="utf-8">
<title><?php echo $_cbase['sys_name']; ?> - 起始首页</title>
...
<div style="max-width:720px;margin:10px auto;">
  <table width="100%" border="1" class="tblist">
    ...
    <?php } } ?>
    <tr class="tc">
      <td><h4><?php echo $_cbase['sys_name']; ?> - 起始页</h4></td>
...
<div>
  ...
  <table width="100%" border="1" class="tblist">
    ...
    <tr class="tc">
      ...
      <td><a href="<?php echo $mapurl; ?>baidu">baidu地图</a>-<a href="<?php echo $mapurl; ?>baidu&act=pick&point=113.756963,23.02224,17">pick</a></td>
      <td><a href="<?php echo $mapurl; ?>google">google地图</a>-<a href="<?php echo $mapurl; ?>google&act=pick&point=113.750633,23.016454,16">pick</a></a></td>
    </tr> 
    <tr class="tc">
      <td><a href="binfo.php?login">工具登录</a></td>
      ...
      <td><a href="dbadm.php">数据库管理</a></td>
    </tr> 
  </table>
</div>
...
<div>
  ...
  <table width="100%" border="1" class="tblist">
    <tr class="tc">
      ...
      <td width="25%"><a href="<?php echo $url; ?>"><?php echo $v[0] ? "($k)$v[0]" : ''; ?></a></td>
