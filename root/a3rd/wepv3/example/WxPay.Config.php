...
require_once dirname(dirname(__DIR__)).'/a3rd_cfgs.php';
/**
*
...
require_once dirname(__DIR__)."/lib/WxPay.Config.Interface.php";
require_once dirname(__DIR__)."/lib/WxPay.Data.php";
require_once dirname(__DIR__)."/lib/WxPay.Exception.php";
require_once dirname(__DIR__).'/lib/WxPay.Notify.php';
require_once __DIR__.'/log.php';
require_once __DIR__.'/WxPay.JsApiPay.php';
require_once __DIR__.'/WxPay.MicroPay.php';
...
class WxPayConfig extends WxPayConfigInterface
{
	...
	{
		return $this->cfgs['appid']; 
	}
	public function GetMerchantId()
	{
		return $this->cfgs['mchid']; 
	}
	...
	**/
	...
	{
		return "http://www.gdzhuoke.com/qygwxregister.php";
	}
	public function GetSignType()
	{
		return $this->cfgs['signtype']; //"MD5"; // HMAC-SHA256,MD5
	}
