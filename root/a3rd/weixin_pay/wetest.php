...
$msgItems = array(
    array('title'=>'测试新闻1','description'=>'描述1','url'=>'http://192.168.1.11/auto/admina.php?','picurl'=>'http://192.168.1.11/auto/images/admina/_pub/logo.png',),
    array('title'=>'测试新闻2','description'=>'描述2','url'=>'http://192.168.1.11/auto/admina.php?','picurl'=>'http://192.168.1.11/auto/images/admina/_pub/logo.png',),
);
...
$msgItems = array( //较好的效果为大图360*200，小图200*200,  小语交互,微简历,微名片
    ...
    array('title'=>'微名片','description'=>'和平鸽工作室','url'=>'http://yscode.txjia.com/about/card.htm?','picurl'=>'http://yscode.txjia.com/uimgs/_pub/logo/gezi1.jpg',),
    array('title'=>'天气预报','description'=>'全国天气','url'=>'http://yscode.txjia.com/about/tianqi.htm?','picurl'=>'http://yscode.txjia.com/uimgs/_pub/logo/gezi-fly.gif',),
);
...
// ============= xxxxxxx
$wxmat = new wmpMaterial($_ex_wechat['tys']);
$data = $wxmat->tmpUpload('/skin/_pub/logo/gezi1-40x.jpg');
echo "\n"; echo "<pre>"; 
print_r($data); 
...
print_r(usrExtra::fmtUserName($data));
echo "\n"; print_r($data); echo "\n";
//*/
