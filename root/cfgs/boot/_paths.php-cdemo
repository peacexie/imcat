...
define('DIR_IMCAT',  DIR_PROJ.'/imcat');  define('PATH_IMCAT',  PATH_PROJ.'/imcat'); //web_code主要流程代码目录
define('DIR_VIEWS',  DIR_PROJ.'/views');  define('PATH_VIEWS',  PATH_PROJ.'/views'); //模板资源目录，一般不需要修改

define('DIR_VARS',   DIR_PROJ.DS.'xvars'); define('PATH_VARS',   PATH_PROJ.'/xvars'); //variable可变目录 
