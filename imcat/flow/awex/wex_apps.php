...
if($view=='list'){ 
    ...
    if($rs=$dop->getRecs()){ 
        foreach($rs as $r){ 
          ...
          echo "<td class='tc'><a href='?awex-wex_menu&wekid=$r[kid]' target='_blank'>$cnav[menu]</a></td>\n";
          echo "<td class='tc'><a href='?awex-wex_user&wekid=$r[kid]' target='_blank'>$cnav[user]</a></td>\n";
          echo "<td class='tc'><a href='?awex-wex_msg3&wekid=$r[kid]' target='_blank'>$cnav[msg]</a></td>\n";
          echo "<td class='tc'><a href='?awex-wex_rkey&wekid=$r[kid]' target='_blank'>$cnav[kw]</a></td>\n";
