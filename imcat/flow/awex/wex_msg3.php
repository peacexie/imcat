...
$mlink = "<p class='tc pv5'>
   <a href='?awex-wex_msg3&wekid=$wekid&view=list'>$cmsg[get]</a>
 # <a href='?awex-wex_msg3&wekid=$wekid&view=send'>$cmsg[send]</a>
 # <a href='?awex-wex_msg3&wekid=$wekid&view=form' onclick=\"return winOpen(this,'$cmsg[ms]',780,560);\">$cmsg[ms]</a>
...
if($view=='list'){ 
    ...
    if($rs=$dop->getRecs()){ 
        foreach($rs as $r){ 
          ...
          echo $cv->Url($cmsg['nrep'],1,"?awex-wex_msg3&kid=$kid&view=form&wekid=$wekid",$cmsg['rep']);
          echo "</tr>";
        }
