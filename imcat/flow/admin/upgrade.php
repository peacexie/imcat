...
if($mod=='insupmod'){
    ...
    echo "\n<tr><td colspan=2><iframe src='http://txjia.com/imcat/dev.php?extend' width='100%' height='480' frameBorder=0></iframe></td></tr>\n";
    $out = "<a href='http://txjia.com/imcat/dev.php?extend' target='_blank' class='center'>More...</a>";
