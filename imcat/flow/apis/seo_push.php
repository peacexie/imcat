...
if($pid=='create'){
    ...
    $go = "<a href='?$mkv&pid=seo_pset'>".lang('flow.dops_back')."</a>";
    ...
    foreach($list as $r){
      ...
      $url1 = $cv->Url(lang('flow.pu_create'),0,"?$mkv&pid=create&job=$kid",lang('flow.pu_create'));
    ...
    if(!empty($bsend)){
        ...
        basMsg::show($msg,'Redir',"?$mkv&pid=$pid");
    }
