...
<?php include DIR_VIEWS."/demo/tester/tester-nav.htm"; ?>
...
<br> view source-code: 
  <a href='<?php echo surl(0)."?info-coder&tpls=tester/ufile.php"; ?>' target="_blank">查看代码</a>
</nav>
