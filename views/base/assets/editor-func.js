...
function edt_showBar(fid){
    ...
    //bar += "<a onClick=\"winOpen('"+_cbase.run.fbase+"?editor-em&fid="+fid+"','插入常用表情图',600,420)\" title=\"插入常用表情图\n(7套方案)\">表情</a>";
    bar += "<a onClick=\"winOpen('"+_cbase.run.fbase+"?editor-tpl_char&fid="+fid+"&pSub=baidu','"+lang('jedt.inschar')+"',720,560)\" title=\""+lang('jedt.inschar')+"\n("+lang('jedt.ncase',3)+")\">"+lang('jedt.char')+"</a>";
    bar += "<a onClick=\"winOpen('"+_cbase.run.fbase+"?editor-tpl_doc&fid="+fid+"&pSub=common','"+lang('jedt.instpl')+"',720,560)\" title=\""+lang('jedt.instpl')+"\n("+lang('jedt.ncase',2)+")\">"+lang('jedt.tpl')+"</a>";
    bar += "<a onClick=\"winOpen('"+_cbase.run.fbase+"?file-fview&fid="+fid+"&mod="+mod+"&kid="+kid+"','"+lang('jedt.fadmin')+"',720,560)\" title=\""+lang('jedt.fadmin')+"\n("+lang('jedt.fpick',2)+")\">"+lang('jedt.file')+"</a>";
    bar += "<a onClick=\"winOpen('"+_cbase.run.fbase+"?file-media&fid="+fid+"&mod="+mod+"&kid="+kid+"','"+lang('jedt.insmedia')+"',720,560)\" title=\""+lang('jedt.insmedia')+"\n("+lang('jedt.mtitle',2)+")\">"+lang('jedt.media')+"</a>";
    ...
    //bar += "<a onClick=\"winOpen('"+_cbase.run.fbase+"/plus/mfunc/dialog.htm?fid="+fid+"','插入数学公式',720,560)\" title=\"插入数学公式\">公式</a>";
