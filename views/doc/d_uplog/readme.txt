...
* Cover files
 - /imcat/core/ >> blib/clib/glib/sdev subdirs
...
* Backup configuration again
 ...
 - set: /imcat and /root writeable (to add files or modify files to be copied when upgrading).
...
* Upgrade Files:
 - Dirs: /imcat, core/ The newly added files and most of the modified files will be copied directly;
 - For copy files, please set dirs: /imcat, core/ writeable;
 - A small number of config files, will prompt comparison, please carefully contrast, and update.
 - Manual deel dirs: /views/ Template directory, please manually processing; Pay attention the dir _pub/jslib(generic JS library);
...
* Clean up and Finish
 ...
 - [Suggest]Set dir: /imcat and /root Can NOT write.
