...
* 备份程序文件
 - 主要备份：/code 和 /root目录。
 - 重要文件（夹）：/code/cfgs/目录，/root/run/_paths.php文件。
...
* 文件升级：
 ...
 - 手动处理/code/tpls/目录：模板目录，一般都修改过，请自行手动处理；
 - 手动处理/root/skin/目录：与处理/code/tpls/目录类似，但注意需要更新jslib子目录的文件（通用js库）；
