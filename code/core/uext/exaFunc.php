...
class exaFunc{
    ...
    static function admenu_m1012(&$s0){
        ...
        <ul class="adf_mnu2" id="left_m2test">
          ...
          <li id="left_m3b3"><a href="?mkv=admin-types&mod=indep" target="adf_main">'.basLang::show('admin.ef_dept').'</a></li>
          <li id="left_m3b1"><a href="?mkv=admin-types&mod=brand" target="adf_main">'.basLang::show('admin.ef_brand').'</a></li>
          <li id="left_m3b2"><a href="?mkv=admin-types&mod=china" target="adf_main">'.basLang::show('admin.ef_china').'</a></li>
