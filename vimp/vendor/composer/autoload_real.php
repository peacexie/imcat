...
class ComposerAutoinit
{
    ...
    public static function getLoader()
    {
        ...
        spl_autoload_register(array('ComposerAutoinit', 'loadClassLoader'), true, true);
        self::$loader = $loader = new \Composer\Autoload\ClassLoader();
        spl_autoload_unregister(array('ComposerAutoinit', 'loadClassLoader'));
