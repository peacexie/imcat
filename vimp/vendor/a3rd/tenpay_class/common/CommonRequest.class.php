...
require_once (dirname(__FILE__)."/SDKRuntimeException.class.php");
require_once (dirname(__FILE__)."/util/CommonUtil.php");
require_once (dirname(__FILE__)."/util/MD5SignUtil.php");
class CommonRequest {
